...
import net.generica.katalog.config.audit.AuditEventConverter;
import net.generica.katalog.domain.PersistentAuditEvent;
...
import static net.generica.katalog.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
