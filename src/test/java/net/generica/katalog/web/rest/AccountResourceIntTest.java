...
import net.generica.katalog.config.Constants;
import net.generica.katalog.domain.Authority;
import net.generica.katalog.domain.User;
import net.generica.katalog.repository.AuthorityRepository;
import net.generica.katalog.repository.UserRepository;
import net.generica.katalog.security.AuthoritiesConstants;
import net.generica.katalog.service.MailService;
import net.generica.katalog.service.UserService;
import net.generica.katalog.service.dto.PasswordChangeDTO;
import net.generica.katalog.service.dto.UserDTO;
import net.generica.katalog.web.rest.errors.ExceptionTranslator;
import net.generica.katalog.web.rest.vm.KeyAndPasswordVM;
import net.generica.katalog.web.rest.vm.ManagedUserVM;
