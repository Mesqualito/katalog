...
import { SingleComponent } from 'app/entities/single/single.component';
import { SingleService } from 'app/entities/single/single.service';
import { Single } from 'app/shared/model/single.model';

describe('Component Tests', () => {
    describe('Single Management Component', () => {
        let comp: SingleComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SingleComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.singles[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
