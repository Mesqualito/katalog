...
import { BezeichnungComponent } from 'app/entities/bezeichnung/bezeichnung.component';
...
describe('Component Tests', () => {
    describe('Bezeichnung Management Component', () => {
        let comp: BezeichnungComponent;
        let fixture: ComponentFixture<BezeichnungComponent>;
        let service: BezeichnungService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [KatalogTestModule],
                declarations: [BezeichnungComponent],
                providers: [
                    {
                ...
                .overrideTemplate(BezeichnungComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(BezeichnungComponent);
