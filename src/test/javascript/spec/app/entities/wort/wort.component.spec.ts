...
import { WortComponent } from 'app/entities/wort/wort.component';
import { WortService } from 'app/entities/wort/wort.service';
import { Wort } from 'app/shared/model/wort.model';

describe('Component Tests', () => {
    describe('Wort Management Component', () => {
        let comp: WortComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(WortComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.worts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
