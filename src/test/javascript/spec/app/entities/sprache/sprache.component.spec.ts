...
import { SpracheComponent } from 'app/entities/sprache/sprache.component';
import { SpracheService } from 'app/entities/sprache/sprache.service';
import { Sprache } from 'app/shared/model/sprache.model';

describe('Component Tests', () => {
    describe('Sprache Management Component', () => {
        let comp: SpracheComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SpracheComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.spraches[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
