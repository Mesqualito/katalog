...
import { GruppeComponent } from 'app/entities/gruppe/gruppe.component';
import { GruppeService } from 'app/entities/gruppe/gruppe.service';
import { Gruppe } from 'app/shared/model/gruppe.model';

describe('Component Tests', () => {
    describe('Gruppe Management Component', () => {
        let comp: GruppeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GruppeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.gruppes[0]).toEqual(jasmine.objectContaining({ id: '123' }));
        });
